...
const RequestTypeStep: React.FC<RequestTypeStepProps> = ({ register, errors, showErrors, touchedFields }) => {
        ...
        <div className="space-y-6">
            <div className="flex flex-col">
                <label className="text-sm font-medium text-text-primary mb-3">
                    {t("requestCreate.form.requestType")} <span className="text-text-error">*</span>
                </label>
                <div className={getRadioContainerClassName("requestType")}>
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        />
                        <span className="text-text-primary">{t("requestCreate.form.requestTypeOptions.eseti")}</span>
                    </label>
                    <label className="flex items-center gap-3 cursor-pointer">
                        <input
                            type="radio"
                            ...
                            className="w-5 h-5 text-primary focus:ring-primary"
                        />
                        <span className="text-text-primary">{t("requestCreate.form.requestTypeOptions.folyamatos")}</span>
                    </label>
                </div>
                {shouldShowError("requestType") && (
